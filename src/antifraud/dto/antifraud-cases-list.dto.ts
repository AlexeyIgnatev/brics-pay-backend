...
import {
  TransactionsListDto,
  TransactionItemDto,
} from '../../transactions/dto/transactions-list.dto';

export class AntifraudCasesListDto {
  @ApiPropertyOptional({
    type: [String],
    description: 'Типы транзакций',
    example: ['BANK_TO_BANK', 'WALLET_TO_WALLET'],
  })
  @IsOptional()
  @IsArray()
  @Transform(({ value }) =>
  ...
  @ApiPropertyOptional({
    ...
    example: ['SUCCESS', 'FAILED', 'REJECTED'],
  })
  @IsOptional()
  @IsArray()
  @Transform(({ value }) =>
  ...
  @ApiPropertyOptional({
    description: 'Дата c (ISO) по полю transaction.createdAt',
  })
  @IsOptional()
  @IsDateString()
  date_from?: string;
  ...
  @ApiPropertyOptional({
    description: 'Дата по (ISO) по полю transaction.createdAt',
  })
  @IsOptional()
  @IsDateString()
  date_to?: string;
  ...
  @ApiPropertyOptional({
    description: 'Минимальная сумма (SOM), фильтр по transaction.amount_out',
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Максимальная сумма (SOM), фильтр по transaction.amount_out',
  })
  @IsOptional()
  @IsNumber()
  @Transform(({ value }) => (value != null ? Number(value) : undefined))
  ...
  @ApiPropertyOptional({
    description: 'ID операции банка (bank_op_id) транзакции',
  })
  @IsOptional()
  @IsInt()
  @Transform(({ value }) => (value != null ? Number(value) : undefined))
  ...
  @ApiPropertyOptional({
    description: 'Поиск по отправителю (FIO/телефон/email/кошелек)',
  })
  @IsOptional()
  @IsString()
  sender?: string;
  ...
  @ApiPropertyOptional({
    description: 'Поиск по получателю (FIO/телефон/email/кошелек)',
  })
  @IsOptional()
  @IsString()
  receiver?: string;
  ...
  @ApiPropertyOptional({
    enum: ['createdAt', 'amount', 'status', 'kind'],
    default: 'createdAt',
  })
  @IsOptional()
