...
export class TransactionsListDto {
  ...
  @ApiPropertyOptional({
    description: 'Search by sender (FIO/phone/email/wallet)',
  })
  @IsOptional()
  @IsString()
  sender?: string;
  ...
  @ApiPropertyOptional({
    description: 'Search by receiver (FIO/phone/email/wallet)',
  })
  @IsOptional()
  @IsString()
  receiver?: string;
...
export class TransactionItemDto {
  ...
  @ApiProperty({ description: 'Operation amount in asset units' })
  amount: number;
  @ApiProperty({
    required: false,
    description: 'Commission amount in operation asset units',
  })
  fee_amount?: number;
  ...
  @ApiProperty({
    required: false,
    description: 'Sender ABS ID (alias of sender_customer_id)',
  })
  sender_abs_id?: number;
  @ApiProperty({
    required: false,
    description: 'Receiver ABS ID (alias of receiver_customer_id)',
  })
  receiver_abs_id?: number;
  @ApiProperty({
    required: false,
    description: 'Client ABS ID for transaction row',
  })
  ...
  @ApiProperty({ required: false, type: () => CustomerBriefDto })
  receiver_customer?: CustomerBriefDto;
}
